  ...
  return (
    ...
    <form className="admin-form admin-form__add-card" name="add-card" id="add-card" onSubmit={(e) => handleSubmit(e)}>
      ...
      <div className="admin-form__checkbox-list">
        ...
        <p className="admin-form__checkbox-text" onClick={() => setShowAll(!showAll)}>Выберите тип ухода из списка <span className={`menu__arrow admin-form__button_arrow ${showAll && 'arrow-open'}`}></span></p>
